...
#criar nossa janela
jan = Tk()
jan.title("Programa de ísis Telck")
...
UserLabel = Label(RightFrame, text="Usuário:", font=("Century Gothic", 20), bg="#565264", fg="white")
UserLabel.place(x=5,y=100)

UserEntry = ttk.Entry(RightFrame,width=30)
UserEntry.place(x=150,y=110)

PassLabel = Label(RightFrame, text="Senha:", font=("Century Gothic", 20), bg="#565264", fg="white")
...
def Register():
    ...
    NomeLabel = Label(RightFrame, text="Nome:", font=("Century Gothic", 20), bg="#565264", fg="white")
